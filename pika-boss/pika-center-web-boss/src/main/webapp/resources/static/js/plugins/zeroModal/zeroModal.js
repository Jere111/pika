...
(function(obj) {
    ...
    _zero_modal_template += '           {{#url}}<div class="zeromodal-loading1"></div>{{#iframe}}<iframe zero-unique-frame="{{unique}}" src="{{url}}" class="zeromodal-frame" id="zeromodalIframe"></iframe>{{/iframe}}{{/url}}';
    _zero_modal_template += '       </div>';
